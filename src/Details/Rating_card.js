    ...
    <section className="relative bg-gradient-to-br from-[#D9F1F1] via-[#F4EEFC] to-[#D3D3F5] py-24 px-6 sm:px-12 lg:px-24 rounded-[40px] mx-4 my-16 shadow-xl overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        {testimonials.map((testimonial, idx) => (
          <div
            key={idx}
            className="bg-white/40 backdrop-blur-xl border border-white/30 rounded-3xl p-6 shadow-[0_4px_60px_rgba(0,0,0,0.05)] hover:shadow-[0_10px_50px_rgba(0,0,0,0.1)] transform hover:-translate-y-1 transition duration-300"
          >
      ...
      <div className="mt-16 text-center">
        <button className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white px-8 py-3 rounded-full font-semibold hover:from-cyan-600 hover:to-cyan-700 transition duration-300 shadow-lg hover:shadow-xl">
